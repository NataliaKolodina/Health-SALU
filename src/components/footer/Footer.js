    ...
    <footer className="footer footer-background">
      <div className=' container'>
        ...
        <div className="footer-contact">
          <p className="footer-contact__text">Контактная информация: <a  className="footer-contact__mail" href="mailto:support@healthapp.com">support@healthapp.com</a></p>
          <nav className="footer-links">
          <ul className="footer-links-list">
            <li className="footer-links-item"><button className="footer-links__btn" onClick={() => openModal(<About />)}>О приложении</button></li>
            <li className="footer-links-item"><button className="footer-links__btn" onClick={() => openModal(<PrivacyPolicy />)}>Политика конфиденциальности</button></li>
            <li className="footer-links-item"><button className="footer-links__btn" onClick={() => openModal(<Terms />)}>Условия использования</button></li>
          </ul>
        </nav>
        </div>
