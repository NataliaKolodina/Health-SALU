    ...
    <footer className="footer footer-background">
      <div className=' container'>
        ...
        <div className="footer-social">
          <a href="https://facebook.com" target="_blank" className="social-icon" rel="noopener noreferrer">
        ...
        <div className="footer-links">
          <button onClick={() => openModal(<About />)} className="footer-link-button">About</button>
          <button onClick={() => openModal(<PrivacyPolicy />)} className="footer-link-button">Privacy Policy</button>
          <button onClick={() => openModal(<Terms />)} className="footer-link-button">Terms and Conditions</button>
        </div>
        <div className="footer-text">Habit Tracker &copy; 2024</div>
      </div>
      </div>
